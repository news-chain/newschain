...
#define NEWS_GENESIS_TIME               (fc::time_point_sec(1533633600))
...
#define NEWS_ACCEPT_NAME_PUBLIC_KEY      (std::string(news::base::public_key_type(NEWS_ACCEPT_NAME_PRIVATE_KEY.get_public_key())))
